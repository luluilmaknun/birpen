...
class GetAsistenTest(TestCase):
    ...
    def test_admin_get_asisten(self):
        self.client.credentials(HTTP_AUTHORIZATION='Bearer ' + self.token_admin)

        response = self.client.post('/api/asdos/get/',
    ...
    def test_mahasiswa_get_asisten(self):
        self.client.credentials(HTTP_AUTHORIZATION='Bearer ' + self.token_mahasiswa)

        response = self.client.post('/api/asdos/create-get/',
                                    data=urlencode(MultiValueDict({
    ...
    def test_asisten_get_asisten(self):
    ...
    def test_dosen_get_asisten(self):
